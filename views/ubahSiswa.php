    ...
    if ($_SESSION['login'] == 1) {
        if (!empty($_GET['id_user'])){
            ...
            $siswaQuery = mysql_query("SELECT * FROM siswa JOIN user ON siswa.id_user=user.id_user WHERE siswa.id_user=$id_user");
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Ubah Data Siswa</strong>
                                    </div>
                                    <form action="systems/ubahSiswa.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="card-body card-block">
                                            <input type="hidden" name="id_user" value="<?php echo $id_user?>">
                                            <div class="row form-group">
                                                <div class="col col-md-2"><label for="text-input" class=" form-control-label">NIS</label></div>
                                                <div class="col-12 col-md-5"><input type="text" id="text-input" name="nis" placeholder="Masukan NIS" class="form-control" value="<?php echo $siswa['NIS']; ?>" disabled></div>
                                            </div>
                                            <div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-md-5">
                                                    <select name="kelas" id="multiple-select" multiple="" class="form-control">
                                                        <option value="<?php echo $siswa['Kelas']?>" selected><?php echo "Kelas ".$siswa['Kelas']?></option>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5"><input type="text" id="text-input" name="username" placeholder="Masukan Username" class="form-control" value="<?php echo $siswa['username']; ?>" disabled><small class="help-block form-text">*Masukan username digunakan untuk login</small></div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-2"><label for="password-input" class=" form-control-label">Password</label></div>
                                                <div class="col-12 col-md-5"><input type="password" id="password-input" name="password" placeholder="Masukan Password" class="form-control" value="<?php echo $siswa['password']; ?>" required><small class="help-block form-text">*Gunakan 8 karakter dengan kombinasi huruf dan angka</small></div>
                                            </div>
                                        </div>
