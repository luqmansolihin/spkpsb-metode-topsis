                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Perbaikan Data Prestasi</strong>
                                </div>
                                <form action="systems/perbaikanPrestasi.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-5"><input type="number" id="text-input" name="nilaiSemester1" value="<?php echo $prestasi['nilai_sem1']; ?>" placeholder="Masukan Nilai Rata-Rata Semester 1" class="form-control"><small class="help-block form-text">*Masukan Nilai Dalam Skala 0-100</small></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Nilai Rata-Rata Semester 2</label></div>
                                            <div class="col-12 col-md-5"><input type="number" id="text-input" name="nilaiSemester2" value="<?php echo $prestasi['nilai_sem2']; ?>" placeholder="Masukan Nilai Rata-Rata Semester 2" class="form-control"><small class="help-block form-text">*Masukan Nilai Dalam Skala 0-100</small></div>
                                        </div>
                                        <div class="row form-group">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-5"><input type="text" id="text-input" name="poinTingkahLaku" value="<?php echo $prestasi['kredit_poin']; ?>" placeholder="Masukan Nilai Poin Tingkah Laku" class="form-control"><small class="help-block form-text">*Masukan Nilai Dalam Skala 0-100</small></div>
                                        </div>    
                                    </div>
