                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Masukan Data Guru</strong>
                                </div>
                                <form action="systems/masukanGuru.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            <div class="col col-md-2"><label for="text-input" class=" form-control-label">NIP</label></div>
                                            <div class="col-12 col-md-5"><input type="text" id="text-input" name="nip" placeholder="Masukan NIP" class="form-control" required></div>
                                        </div>
                                        <div class="row form-group">
