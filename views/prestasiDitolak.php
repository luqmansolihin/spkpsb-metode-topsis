                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Data Prestasi Siswa Ditolak</strong>
                                </div>
                                <div class="card-body">
                                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php                                        
                                            $prestasiQuery = mysql_query("SELECT * FROM prestasi JOIN siswa ON prestasi.id_siswa=siswa.id_siswa WHERE prestasi.status='3' ORDER BY siswa.NIS ASC");
                                            $i = 1;
